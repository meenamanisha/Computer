  ...
  <div class="container">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="" id="tablecon">
        ...
        {
          $qry = "select * from products where id>=51 and id<76";
          $a = useDatabase($qry);
        }?>
      ...
      <div class="col-md-12 col-md-offset-2" style="padding:20px;">
        <nav aria-label="...">
          <ul class="pagination pagination-lg">
            <li class="page-item ">
              <a style="font-size:30px;padding-left:25px;padding-right:25px;" class="page-link" href="home1.php" aria-label="Previous">
                <span aria-hidden="true">&laquo;</span>
                <span class="sr-only">Previous</span>
              </a>
            </li>
            <li class="page-item"><a style="font-size:30px; padding-left:25px;padding-right:25px;" class="page-link" href="home.php">1</a></li>
            <li class="page-item"><a style="font-size:30px; padding-left:25px; padding-right:25px;" class="page-link active" href="home1.php">2</a></li>
            <li class="active"><a style="font-size:30px; padding-left:25px; padding-right:25px;"class="page-link" href="home2.php">3</a></li>
            <li class="page-item"><a style="font-size:30px;padding-left:25px; padding-right:25px;" class="page-link" href="home3.php">4</a></li>
            <li class="page-item">
              <a  style="font-size:30px;padding-left:25px; padding-right:25px;" class="page-link" href="home3.php" aria-label="Next">
