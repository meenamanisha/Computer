  ...
  <div class="container">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="" id="tablecon">
        ...
        {
          $qry = "select * from products where id>=26 and id<51";
          $a = useDatabase($qry);
        }?>
      ...
      <div class="col-md-12 col-md-offset-2" style="padding:20px;">
        <nav aria-label="...">
          <ul class="pagination pagination-lg">
            <li class="page-item">
              <a style="font-size:30px;padding-left:25px;padding-right:25px;" class="page-link" href="home.php" aria-label="Previous">
            ...
            <li class="active"><a style="font-size:30px; padding-left:25px; padding-right:25px;" class="page-link active" href="home1.php">2</a></li>
            ...
            <li class="page-item">
              <a  style="font-size:30px;padding-left:25px; padding-right:25px;" class="page-link" href="home2.php" aria-label="Next">
