  ...
  <div class="container">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="" id="tablecon">
        ...
        {
          $qry = "select * from products where id>=101 and id<126";
          $a = useDatabase($qry);
        }?>
      ...
      <div class="col-md-12 col-md-offset-2" style="padding:20px;">
        <nav aria-label="...">
          <ul class="pagination pagination-lg">
            <li class="page-item">
              <a style="font-size:30px;padding-left:25px;padding-right:25px;" class="page-link" href="home3.php" aria-label="Previous">
            ...
            <li class="active"><a style="font-size:30px;padding-left:25px; padding-right:25px;" class="page-link" href="home4.php">5</a></li>
            <li class="page-item"><a style="font-size:30px; padding-left:25px;padding-right:25px;" class="page-link" href="home5.php">6</a></li>
